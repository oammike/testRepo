...
with(obj||{}){
__p+='<div class="actions">\n  <ul class="chooser">\n    <li class="open-menu item"> <a href="#change_cover_photo"><i class="fa fa-camera"></i> &nbsp;&nbsp; Change Cover Photo</a></li>\n    <ul class="sub-menu">\n      <li class="upload item"><a href="#upload_cover_photo"><i class="fa fa-upload"></i> &nbsp; &nbsp; Upload new photo</a></li>\n    </ul>\n  </ul>\n  <ul class="edit">\n    <li class="cancel item"><a href="#cancel">Cancel</a></li>\n    <li class="save item"><a href="#save">Save</a></li>\n  </ul>\n</div>';
}
return __p;
};
