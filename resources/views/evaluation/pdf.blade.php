                            ...
                            <tr>
                              ...
                              <table class="table table-striped" style="font-size:0.8em; font-family:'Roboto',Arial,sans-serif">
                                ...
                                <table border="0" width="100%">
                                  ...
                                  Employee : <br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>
                                  @if ( file_exists('public/img/employees/'.$employee->id.'-sign.png') ) <img src="{{asset('public/img/employees/'.$employee->id.'-sign.png')}}" width="150" style="margin-bottom:-20px" /><br/>
                                  ...
                                  Date : </p>
                                    ...
                                    <td>
                                      ...
                                      @if ( file_exists('public/img/employees/'.$evaluatorData->id.'-sign.png') )
                                       <p style="font-size:0.8em"><br/>
                                  Evaluator :<br/>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/><img width="150" src="{{asset('public/img/employees/'.$evaluatorData->id.'-sign.png')}}" style="margin-bottom:-20px" /><br/> _____________________________
