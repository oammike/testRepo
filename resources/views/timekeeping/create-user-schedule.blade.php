            ...
            <div class="box box-primary">
              ...
              <div class="box-body box-profile" style="padding-top:50px">
                ...
                <div class="row">
                  ...
                  <!-- ****** SCHEDULE COL ********** -->
                  <div class="col-lg-7">
                        <blockquote><p class="text-success">Specify type of schedule</p><small> Is this a fixed schedule, or a shifting schedule?<br/><br/>
                        <em style="font-size:.9em;">Shifting schedule means employee would have to change his/her work shifts (day shift to a night shift, or vice-versa) within a given period...</em><br/></small><br/>
